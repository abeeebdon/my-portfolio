...
export const project = [
  {
    id: 1,
    name: 'TiFI',
    image: '/img/image.avif',
    link: 'https://tifi.tv/',
    details:
      'I collaborated with a diverse team of developers at HNG to develop Tifi, Tifi is an AI-powered platform that convert between various content type such as conversion of audio to text, text to audio. It also includes summarizing video, pdf contents',
    stack:
